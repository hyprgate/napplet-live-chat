...
/**
 * Shared kind-0 profile-metadata subscription (feed / live-chat / movie — keep the
 * three byte-identical, anti-drift).
 */
...
export function subscribeProfileMetadata(
  ...
  // The returned { close } is synchronous and honors early close().
  void (async () => {
